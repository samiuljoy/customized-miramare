...
" Author:       Francisco Bach <franciscobach@gmail.com> and edited by Samiul
" Joy
" Website:      https://github.com/franbach/miramare &&
" https://github.com/samiuljoy/customized-miramare
" License:      MIT
" -----------------------------------------------------------------------------
...
let s:configuration.disable_italic_comment = get(g:, 'miramare_disable_italic_comment', 1)
...
let s:palette = {
      ...
      \ 'light_grey': ['#8489a7',   '245',  'LightGrey'],
      \ 'gold':       ['#d8caac',   '214',  'Yellow'],
      \ 'none':       ['NONE',      'NONE', 'NONE'],
      \ 'white':      ['#ffffff',   '255',  'whiite'],
      \ 'cvisual':    ['#272c42',   '240',  'cvisual'],
      \ 'dgrey':      ['#7f7f7f',   '245',  'DGrey']
      \ }
...
call s:HL('IncSearch', s:palette.white, s:palette.grey)
call s:HL('Search', s:palette.bg0, s:palette.red)
call s:HL('MatchParen', s:palette.white, s:palette.bg_green, 'bold')
...
call s:HL('Visual', s:palette.none, s:palette.cvisual)
...
call s:HL('SpecialKey', s:palette.dgrey, s:palette.none)
...
call s:HL('White', s:palette.white, s:palette.none)
...
highlight! link markdownBlockquote Cyan
highlight! link markdownListMarker Red
highlight! link markdownOrderedListMarker Red
highlight! link markdownRule Purple
highlight! link markdownHeadingRule Orange
highlight! link markdownUrlDelimiter Yellow
highlight! link markdownLinkDelimiter White
highlight! link markdownLinkTextDelimiter Orange
highlight! link markdownHeadingDelimiter White
highlight! link markdownLinkText Purple
highlight! link markdownUrlTitleDelimiter Green
highlight! link markdownIdDeclaration markdownLinkText
highlight! link markdownBoldDelimiter White
...
highlight! link cssVendor White
highlight! link cssNoise White
" }}}
" }}}
" SASS: {{{
" builtin: {{{
